/*
	...
	QA: What are we getting: two strings
		what do we return? an integer of jewels;
			any integers? 
				are each character a jewels? yes ok 
	So my first thought would to store these jewels references so that we can recall when we scan our pile of stonesl Does this sound ok? 
