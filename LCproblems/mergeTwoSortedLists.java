...
If they are already sorted we should just move the links between them
	loop through each with a starter new node and have the next be the head of that semi new list
*/		
