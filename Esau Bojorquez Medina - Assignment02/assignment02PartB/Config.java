...
public final class Config {
    ...
    private static final String defaultLogDirectoryPath = "./src/assignment01PartB/log/"; // Default
    private static final String defaultStdOutFilePath = "./src/assignment01PartB/log/StandardOut.log"; // Default
    private static final String defaultStdErrFilePath = "./src/assignment01PartB/log/StandardErr.log"; // Default
